...
class EvalQuestionGroup(BaseModel):
    class Meta:
...
class Evaluation(NumeratorMixin, BaseModel):
    class Meta:
...
class LectureEvaluation(NumeratorMixin, BaseModel):
    class Meta:
...
class LectureEvaluationScore(BaseModel):
    class Meta:
